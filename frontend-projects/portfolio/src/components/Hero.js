...
export default function Hero() {
  ...
  return (
    <section className="flex flex-col md:flex-row px-5 py-12 bg-color-2 justify-center">
      {/* Need to make the py as 32 for the default */}

      <div className="md:w-1/2 flex flex-col">
        <h1 className="text-amber-700 text-6xl font-main-font">
          Hi, <br />
          I'm <span className="text-black">Gladden</span>
          <p className="text-2xl">{config.subtitle}</p>
        </h1>

        <div className="flex py-10 ">
          <a
            href={config.social.insta}
            className="pr-5 hover:text-emerald-400"
            target="_blank"
          >
