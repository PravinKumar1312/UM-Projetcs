export default function Skills () {
    ...
    return <section className='flex flex-col md:flex-row bg-color-3 px-5' id="skills">

        <div className="md:w-1/2 flex justify-center py-10">
            <div className="flex flex-col text-amber-700 justify-center">
                <h1 className="text-4xl border-b-4 mb-4 font-bold border-[#e9edc9] font-main-font">Skills</h1>
        ...
        <div className="md:w-1/2 flex justify-center py-10">
            <div className="flex flex-col text-amber-700 justify-center">
                <h1 className="text-4xl border-b-4 mb-4 font-bold border-[#e9edc9] font-main-font">Education</h1>
