...
export default function Projects() {
  ...
  return (
    <section
      className="flex flex-col py-20 px-5 justify-center bg-color-4 text-amber-700"
      id="projects"
    >
      <div className="w-full">
        <div className="flex flex-col px-10 py-5">
          <h1 className="text-4xl border-b-5 border-[#797979] mb-5 font-bold font-main-font">
            Projects
          </h1>
